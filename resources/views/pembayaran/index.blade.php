                            ...
                            <div class="col-lg-6">
                                ...
                                <table style="width: 100%" class="mb-3" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><span id="kategori_pelanggan"></span> </td>
                                    </tr>
                                    <tr>
                                        <td>Penggunaan m³</td>
                    ...
                    success: function(data) {
                        ...
                        $.ajax({
                            ...
                            success: function(tarifData) {
                                $.ajax({
                                    url: '/user/get-data/' + user_id,
                                    type: 'GET',
                                    success: function(userData) {
                                        let jumlah_penggunaan = parseFloat($('#jumlah_penggunaan').val());

                                        let tarif;
                                        if (jumlah_penggunaan <= 10) {
                                            tarif = parseFloat(tarifData.tarif_1);
                                        } else if (jumlah_penggunaan <= 20) {
                                            tarif = parseFloat(tarifData.tarif_2);
                                        } else if (jumlah_penggunaan <= 30) {
                                            tarif = parseFloat(tarifData.tarif_3);
                                        } else {
                                            tarif = parseFloat(tarifData.tarif_4);
                                        }

                                        let jenisPelanggan = userData.kategori.kategori;

                                        $('#tarif').text(tarif);
                                        $('#beban').text(tarifData.beban);
                                        $('#denda').text(tarifData.denda);
                                        $('#admin').text(tarifData.admin);
                                        $('#kategori_pelanggan').text(jenisPelanggan);

                                        var beban = parseFloat(tarifData.beban);
                                        var denda = parseFloat(tarifData.denda);
                                        var admin = parseFloat(tarifData.admin);
                                        ...
                                        if (tgl_bayar > tanggal_batas_bayar) {
                                            ...
                                            var totalPembayaran = (jumlah_penggunaan * tarif) + beban + totalDenda + admin;
                                        ...
                                        $('#beban').text(beban);
                                        $('#jenis_pelanggan').text(jenisPelanggan);
                                    }
                                });
                            }
                        });

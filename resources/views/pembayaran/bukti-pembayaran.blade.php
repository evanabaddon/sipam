...
<body>
    <div class="container">
        <div class="header">
            <h2>Bukti Pembayaran Tagihan Air {{ settings()->get('business_name') }}</h2>
        ...
        <div class="detail">
            <table>
                ...
                <tr>
                    <td><strong>Kategori Pelanggan</strong></td>
                    <td>:</td>
                    <td>{{ $pemakaian->user->kategori->kategori }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>Rp. {{ number_format($tarif_beban, 0, ',', '.') }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>Rp. {{ number_format($pembayaran->uang_cash, 0, ',', '.') }}</td>
                </tr>
                <tr>

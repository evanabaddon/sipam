...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['middleware' => 'CheckRole:admin'], function () {
        ...
        Route::get('/user/get-data/{user_id}', [PembayaranController::class, 'getDataUser']);
    ...
    Route::group(['middleware'  => 'CheckRole:pelanggan'], function () {
        ...
        Route::get('channel-pembayaran', [TripayController::class, 'getChannel']);
        Route::post('/cek-tagihan/proses-bayar', [CekTagihanPelangganController::class, 'prosesBayar'])->name('proses-bayar');

        Route::get('/proses-pembayaran', [CekTagihanPelangganController::class, 'prosesPembayaran'])->name('proses-pembayaran');
